...
function Hero() {
    return (
        <section className="relative overflow-hidden bg-linear-to-b from-white 
        to-gray-50 dark:from-black dark:to-gray-950 py-16 sm:py-32">
            {/* Background decoration */}
            {/* <div className='absolute inset-0 bg-[linear-gradient(to_right,
            #80808012_1px,transparent_1px),linear-gradient(to_botton,#80808012_1px,
            transparent_1px)] bg-size-[24px_24px]' /> */}
            ...
            <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    {/* HeadLine */}
                    <h1 className="text-5xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-6xl text-7xl">
                        Generate Professional Newsletter in{" "}
                    ...
                    {/* Subheading */}
                    <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400 text-md sm:text-xl"> 
                    ...
                    <p className="mt-8 text-sm text-gray-500 dark:text-gray-500">
                        Join 1000+ newsletter creators saving 5+ hours every week · 
                        Starting at $9/month.
                    </p>
                </div>
                ...
                <div className="relative mx-auto mt-16 max-w-6xl">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
                        ...
                        <div className="relative shrink-0 w-full lg:w-auto">
                            <div className="grid grid-cols-3 gap-2 lg:gap-6 max-w-xs mx-auto lg:max-w-none">
                                ...
                                <div className="flex flex-col items-center gap-2">
                                    <div 
                                        className="relative size-16 lg:size-24 rounded-full 
                                        bg-linear-to-br from-indigo-500 to-indigo-600 shadow-lg 
                                        flex items-center justify-center animate-pulse"
                        ...
                        <div className="flex flex-col items-center gap-4 my-6 lg:my-0">
                            ...
                            {/* Desktop: Horizontal arrows pointing down */}
                                ...
                                <div className="p-6 space-y-4">
                                    ...
                                    <div>
                                        <div className="flex items-center gap-2 mb-2">
                                            ...
                                            <span className="text-10 font-semibold text-gray-500 
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        ...
                                        dark:border-gray-800 p-2 bg-blue-50 dark:bg-blue-950
                                        /30">
                                            <div className="h-2 w-3/4 rounded bg-blue-300/50 
                                            dark:bg-blue-700/50" />
                                        </div>
                                        <div className="rounded border border-gray-200 
                                        dark:border-gray-800 p-2 bg-purple-50 dark:bg-purple-950
                                        /30">
                                            <div className="h-2 w-3/4 rounded bg-purple-300/50 
